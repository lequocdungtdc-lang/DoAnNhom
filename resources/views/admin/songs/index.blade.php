                ...
                <table class="min-w-full divide-y divide-white/8">
                    <thead class="bg-white/[0.03]">
                        <tr class="text-left text-sm text-[#8a93a3]">
                            ...
                            <th class="px-4 py-3">ID nghệ sĩ</th>
                            <th class="px-4 py-3">ID thể loại</th>
                    ...
                    <tbody class="divide-y divide-white/8 bg-[#11141b]">
                        @forelse ($songs as $song)
                            <tr class="text-sm text-white">
                                ...
                                <td class="px-4 py-4 text-[#a8b1bf]">{{ $song->nghesi ?: 'Chưa có' }}</td>
                                <td class="px-4 py-4 text-[#a8b1bf]">{{ $song->theloai }}</td>
